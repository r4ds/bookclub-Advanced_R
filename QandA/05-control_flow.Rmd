...
## 5.2.2 Vectorised if {-#vectorised-if}
...
### Assignment to a valid index {-#assignment-valid}
...
### Impossible Index `[[` {-#impossible-double}
...
### Impossible Index `[[<-`  {-#impossible-double-assign}
