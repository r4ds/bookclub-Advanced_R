...
TODO: explain this code a little more.... The length of the dataframe is the same, but the length of the matrix is the same as every element of that matrix.
...
We can see where `format()` is called but why does it introduce a space? And why don't we see it in our answer?
