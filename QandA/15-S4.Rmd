...
:::TODO
A virtual class is a class that cannot be instanciated... why would we need this? 
:::
...
:::question
Does anyone know of a case where you'd need to convert your `S3` class to an `S4` class?
:::
