...
\begin{verbatim}
## █ [1:0x7f81989ffab8] <list> 
## └─[2:0x7f8195bbdf28] <dbl>
\end{verbatim}
...
\begin{verbatim}
##  [1] 225 290 281 244 286 237 201 206 294 240
\end{verbatim}
...
I can't quite think of a time where \texttt{try} is more appropraite than \texttt{tryCatch} - does anyone have an example?
...
The protected code is \texttt{message\ =\ function(cnd)\ "There"} and the handler inside the \texttt{\{\}}
...
\addcontentsline{toc}{section}{Custom conditions}

We saw how we can use metadata and \texttt{Restarts} in the presentation, can we transform the base code to use \texttt{rlang::abort}?

XXX

\hypertarget{exercises-6}{%
\section*{8.5.4.2 Exercises}\label{exercises-6}}
\addcontentsline{toc}{section}{8.5.4.2 Exercises}
...
We are passing \texttt{warn("Hello")} as handler code but since it's an \texttt{abort} the protected code \texttt{x} never gets evaluated? That seems wrong.
...
\section*{8.6.6.2 Exercises}\label{exercises-7}}
...
What exactly does this mean? tryCatch evaluates what we were calling the protected code first and calling handlers execute the handling code first?

XXX

\hypertarget{exercises-8}{%
\section*{8.6.6.4 Exercises}\label{exercises-8}}
