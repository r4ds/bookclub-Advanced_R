...
\begin{verbatim}
## █ [1:0x7fc1bd17fe00] <list> 
## └─[2:0x7fc1bb74cac0] <dbl>
\end{verbatim}
...
```r
in\_dir \textless{}- function(dir, code) \{
old \textless{}- setwd(dir)
on.exit(setwd(old))
