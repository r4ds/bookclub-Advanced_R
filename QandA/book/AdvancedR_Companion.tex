...
\begin{verbatim}
## █ [1:0x7f8ea68a5d90] <list> 
## └─[2:0x7f8eabbf3678] <dbl>
\end{verbatim}
...
\begin{verbatim}
##  [1] 227 240 295 271 249 207 202 244 257 217
\end{verbatim}
...
\NormalTok{    )}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
    \KeywordTok{mean}\NormalTok{(.data[[column_name]])}
\NormalTok{  \}}
\NormalTok{\}}

\NormalTok{beer_states }\OperatorTok{%>%}\StringTok{ }\KeywordTok{beer_mean}\NormalTok{(state)}
\end{Highlighting}
\end{Shaded}
