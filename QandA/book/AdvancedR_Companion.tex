...
\begin{verbatim}
## █ [1:0x7fa47ee03010] <list> 
## └─[2:0x7fa48c9543b0] <dbl>
\end{verbatim}
...
\begin{verbatim}
##  [1] 237 242 224 220 255 262 295 268 215 229
\end{verbatim}
...
\NormalTok{replace_not_correct <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(all_text) \{}
  \KeywordTok{lapply}\NormalTok{(all_text, }\ControlFlowTok{function}\NormalTok{(text) \{}
    \KeywordTok{withRestarts}\NormalTok{(}
      ...
      \DataTypeTok{skip_text =} \ControlFlowTok{function}\NormalTok{(e)\{ }\OtherTok{NA}\NormalTok{;  }\KeywordTok{print}\NormalTok{(}\KeywordTok{current_env}\NormalTok{())\}}
\NormalTok{    )}
\NormalTok{  \})}
\NormalTok{\}}
...
\section*{9.6.3.3 Exercise}\label{exercise-12}}
\addcontentsline{toc}{section}{9.6.3.3 Exercise}

\hypertarget{exercise-13}{%
\section*{9.6.3.4 Exercise}\label{exercise-13}}
\addcontentsline{toc}{section}{9.6.3.4 Exercise}
