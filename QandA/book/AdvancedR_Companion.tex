...
\begin{verbatim}
## █ [1:0x7fb10e3cec80] <list> 
## └─[2:0x7fb10bf2eba0] <dbl>
\end{verbatim}
...
\begin{verbatim}
##  [1] 231 263 286 229 296 209 232 259 287 295
\end{verbatim}
...
As a function user it's common to supress warnings when loading in data and using \texttt{readr} and \texttt{dplyr} - but not so much as a function creator
