...
gt::gtsave(functional_programming_summary, filename = here::here('Presentations', 'Week11', 'functional_programming_summary.png'))
```
...
```{r install-fontawesome, eval=FALSE, include=FALSE}
# You only need to do this if you're knitting locally.
