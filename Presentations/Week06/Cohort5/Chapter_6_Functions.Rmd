...
In R, you'll often see functions called __closures__. This name reflects the fact that R functions capture, or enclose, their environments. Key for understanding the dreaded 
...
knitr::include_graphics("https://1sajzl2az82tq30aw1izck61-wpengine.netdna-ssl.com/wp-content/uploads//2020/11/capsule.svg")
```
...
Most often used as a helper in functional programming.
...
Again, it can be a little hard to read, so better to use a `NULL` default and test for it.
...
Can pass these extra arguments to another function.
...
`...` allows any number of arguments to be passed

### Use to pass:

* arbitrary arguments to another function (as in prev.)
* an unknown number of arguments to your function.
